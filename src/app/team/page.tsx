...
import TrusteeCarousel from "@/components/TrusteeCarousel";
    ...
    <>
      ...
      <section id="board" className="team-board">
        ...
        <TrusteeCarousel
          trustees={[
            {
              name: "Afolashade Joy Jubrilla",
              role: "Head of Partnerships | Emergency Response Volunteer",
              bio: "Governance and development strategist with expertise in strategic partnerships, institutional governance, and stakeholder engagement.",
              image: "/images/team/joy2.JPG",
              linkedin: "https://www.linkedin.com/in/afolashadejubrilla",
            },
            {
              name: "Adaobi Umo-Etuk",
              role: "Secretary",
              bio: "Nigerian banking and compliance professional with expertise in regulatory compliance, governance, and organizational integrity.",
              image: "/images/team/adaobi.JPG",
              linkedin: "https://www.linkedin.com/in/adaobi-yvonne-umo-etuk-92318172",
            },
            {
              name: "Adesanya Oluwasegun Emmanuel",
              role: "Team Lead | Humanitarian Project Assistant",
              bio: "Nigerian public servant and community development advocate dedicated to supporting humanitarian projects and community empowerment.",
              image: "/images/team/adesanya.JPG",
              linkedin: "https://linkedin.com",
            },
            {
              name: "Michael Pedro",
              role: "Program Support Volunteer | Humanitarian Project Assistant",
              bio: "Public health and project management professional with 15+ years in health information systems, M&E, and programme implementation.",
              image: "/images/team/michael pedro.JPG",
              linkedin: "https://www.linkedin.com/in/michael-pedro-6865202b",
            },
          ]}
        />
      </section>
